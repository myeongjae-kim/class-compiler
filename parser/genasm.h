/* genasm.h         Header for X86 code generation     ; 03 Dec 17    */
...
#define  XMM1  17       /* Float register: function result */
#define  XMM2  18       /* Float register: function result */
#define  XMM3  19       /* Float register: function result */
#define  XMM4  20       /* Float register: function result */
#define  XMM5  21       /* Float register: function result */
#define  XMM6  22       /* Float register: function result */
#define  XMM7  23       /* Float register: function result */
